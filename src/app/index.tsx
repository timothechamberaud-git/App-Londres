...
// Coordonnées de base étudiante à Londres (Camden Town)
const CAMDEN_LOCATION: Location.LocationObject = {
  coords: {
    latitude: 51.539011,
    longitude: -0.142555,
    altitude: null,
...
export default function Dashboard() {
  ...
  const generateItinerary = async () => {
    try {
      ...
      const todayEvents = items[today] || items['2026-08-17'] || [];
      const now = new Date();
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        console.warn("Erreur géolocalisation, maintien sur Camden Town:", e);
      }
      ...
      try {
        ...
        // Ignorer si batterie non disponible
      }
